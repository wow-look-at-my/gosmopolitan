...
Job-by-job overview: docs/CI.md, "Job overview". It covers what each job builds. It names the suites `cosmo-checks` keeps. It
describes the APE test programs, the wasm gate and the publish chain.
