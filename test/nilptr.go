...
// Address space starts at 1<<32 on AIX, on cosmo, on darwin/arm64 and on windows/[amd64/arm64], so dummy is too far.
//go:build !aix && !cosmo && (!darwin || !arm64) && (!windows || (!amd64 && !arm64))
