...
When Windows and MacOS aren't in the support vector, then the above assembly rewriting pass can be avoided entirely, and the binary can simply use the TLS opcodes that GCC and Clang generate for Linux.
