...
require (
	...
	github.com/wow-look-at-my/go-s3-server/cacheclient v0.0.0-20260913232707-d630605b297f
...
require (
	...
	github.com/wow-look-at-my/go-containers v0.0.0-20260913045023-d3bbbdd0286d // indirect
