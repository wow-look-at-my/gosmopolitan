...
func payloadFromELF(elf []byte) (*apePayload, error) {
	...
	// makeEmbeddedElfHeader, makeMachoHeader, payloadExtent, and
	// stripPayload all index it without further checks, so a truncated
	// or corrupt input would panic there.
