...
func (ld *loader) checkMultiplePaths(loaderstate *State) {
	...
	for _, mod := range mods {
		...
		if prev, ok := firstPath[src]; !ok {
			...
			if isDeliberateReplacement(loaderstate, mod) {
				continue
			}
...
func isDeliberateReplacement(loaderstate *State, mod module.Version) bool {
	return Replacement(loaderstate, mod) != (module.Version{})
}
