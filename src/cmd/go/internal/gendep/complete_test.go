...
// Table.
//
// additions answers the file either way: it compares two trees and knows
// nothing about what they declare. Complete is what drops it, through
// redeclaring, and clash_test.go covers that.
