...
func http2clientPriorityDisabled(_ *Server) bool {
	return true
}
...
type http2serverInternalState struct {
	...
	// Used in tests.
	testNewConn func(*http2serverConn)
}
...
type http2transportInternal struct {
...
func http2configureTransports(t1 *Transport) (*http2Transport, error) {
	...
	t2 := &http2Transport{
		...
		http2transportInternal: http2transportInternal{
			t1: t1,
		},
	}
	connPool.t = t2
...
func (t *http2Transport) newUserClientConn(c net.Conn) (*http2ClientConn, error) {
...
func (cc *http2ClientConn) stopIdleTimer() {
	if cc.idleTimer != nil {
		cc.idleTimer.Stop()
	}
}
...
func (t *http2Transport) roundTripViaPool(req *Request, opt http2RoundTripOpt, pool http2ClientConnPool) (*Response, error) {
