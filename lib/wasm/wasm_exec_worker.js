			...
			switch (msg.type) {
				case "init":
					try {
						...
						// A trap in Go code running on this worker propagates
						// out of the wasm_thread_run call above and lands
						// here; err.stack carries the wasm frames (Go
						// function names via the name section), which is the
						// only crash state a trap leaves behind. Report it.
